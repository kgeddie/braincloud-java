...
public interface ReasonCodes {
    ...
    int INVALID_USER_STATISTICS_EVENT_NAME = 40321;

    // Game Version No Longer Supported
    int GAME_VERSION_NOT_SUPPORTED = 40322;
    int APP_VERSION_NOT_SUPPORTED = 40322;
    ...
    int APP_LIMIT_REACHED = 40371;
    int GAME_RUNSTATE_DISABLED = 40372;
    int APP_RUNSTATE_DISABLED = 40372;
    ...
    int MISSING_APP_PARENT = 40377;
    int GAME_PARENT_MISMATCH = 40378;
    int APP_PARENT_MISMATCH = 40378;
    int CHILD_PLAYER_MISSING = 40379;
    int CHILD_USER_MISSING = 40379;
    int MISSING_PLAYER_PARENT = 40380;
    int MISSING_USER_PARENT = 40380;
    int PLAYER_PARENT_MISMATCH = 40381;
    int USER_PARENT_MISMATCH = 40381;
    int MISSING_PLAYER_ID = 40382;
    int MISSING_USER_ID = 40382;
    ...
    int APP_NOT_FOUND = 40387;
    int GAMES_NOT_IN_SAME_COMPANY = 40388;
    int APPS_NOT_IN_SAME_COMPANY = 40388;
